...
int main(){
    ...
    */
    ...
    Profemon jinga("Jinga", 13444, HARDWARE);
    ...
    vector<Profemon> profemons = {shankar, schweitzer, zamfirescu, raja, levitan, epstein, jinga};
    Trainer t1 = Trainer(profemons);
    Trainer t2 = Trainer();

    MLDepartment m1 = MLDepartment(profemons);
    m1.printTeam();
    HardwareDepartment h1 = HardwareDepartment(profemons);
    h1.printTeam();
    h1.printProfedex();
}
